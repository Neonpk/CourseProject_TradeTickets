...
-- Started on 2026-01-18 22:31:36 +05

\restrict jocfFCTzQ6hcxKFJuhDyJ4crEmAwalNlobNgg7FM8Ifj67ajr9ZU53bhdsctrFx
...
\unrestrict jocfFCTzQ6hcxKFJuhDyJ4crEmAwalNlobNgg7FM8Ifj67ajr9ZU53bhdsctrFx
...
\restrict psDmXvncMOGGFVQIe0VSGlmaJDh80Hntofs1WLuOLpCqsnSk6PqIS4mMf2TsEUF
...
-- Completed on 2026-01-18 22:31:38 +05

--
-- PostgreSQL database dump complete
--

\unrestrict psDmXvncMOGGFVQIe0VSGlmaJDh80Hntofs1WLuOLpCqsnSk6PqIS4mMf2TsEUF
...
\restrict 6TjZmbU0c9Dn5M7NHP4ta4V7HssjHJ2Vf9chCPKIU7LBiXmE9bBsTmYS5lXFQ8f

-- Dumped from database version 18.1
-- Dumped by pg_dump version 18.1

-- Started on 2026-01-18 22:31:38 +05
...
--
-- TOC entry 3631 (class 1262 OID 16388)
...
\unrestrict 6TjZmbU0c9Dn5M7NHP4ta4V7HssjHJ2Vf9chCPKIU7LBiXmE9bBsTmYS5lXFQ8f
...
--
-- TOC entry 3035 (class 3456 OID 16389)
...
--
-- TOC entry 271 (class 1255 OID 32820)
-- Name: generate_avatar(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.generate_avatar(p_url_path character varying) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_hash text;
...
BEGIN
    ...
    -- 1. Генерируем MD5 (32 символа), чтобы влезло в varchar(50) с префиксом
    v_hash := encode(sha256((p_url_path)::bytea), 'hex');

    -- 2. Вставка фото с обработкой ошибок уникальности
    BEGIN
...
ALTER FUNCTION public.generate_avatar(p_url_path character varying) OWNER TO postgres;
...
--
-- TOC entry 3607 (class 0 OID 16405)
-- Dependencies: 219
...
--
-- TOC entry 3609 (class 0 OID 16414)
-- Dependencies: 221
...
--
-- TOC entry 3612 (class 0 OID 16421)
-- Dependencies: 224
...
--
-- TOC entry 3615 (class 0 OID 16446)
-- Dependencies: 227
...
--
-- TOC entry 3618 (class 0 OID 16453)
-- Dependencies: 230
...
97	test_image	https://i.imgur.com/4YzEWI1.jpg	t
...
--
-- TOC entry 3620 (class 0 OID 16461)
-- Dependencies: 232
...
--
-- TOC entry 3622 (class 0 OID 16470)
-- Dependencies: 234
...
--
-- TOC entry 3624 (class 0 OID 16480)
-- Dependencies: 236
...
2	$2a$13$qS4nqsKttEsl2L8DNDEBoOJqgxG3ZT/oKEKvQ1dGRNLa1SKiaKUr6	user2	admin	0,00 ₽	Администратор (Служебный аккаунт)	6	1970-01-01	4516123452	14
4	$2a$13$zZBE47bJzhxvpKnFrYHhXeLvRDKZgYYj1esGSOzOJbW0Diu8tu2m6	client1	user	50 275,50 ₽	Иванов Андрей Викторович	6	1996-07-03	4516123456	39
7	$2a$13$ZHC.oARtTKSKeEyMp6qgsOE2y8Mdt7/aLOXxDcbyEfGarMkakNxKm	client2	user	93,50 ₽	Петров Геннадий Константинович	2	1991-04-15	4516123457	29
\.
...
SELECT pg_catalog.setval('public.aircraft_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.photo_id_seq', 99, true);
...
--
-- TOC entry 3406 (class 2606 OID 16490)
...
--
-- TOC entry 3410 (class 2606 OID 16492)
...
--
-- TOC entry 3424 (class 2606 OID 32813)
...
--
-- TOC entry 3426 (class 2606 OID 16496)
...
--
-- TOC entry 3413 (class 2606 OID 16498)
...
--
-- TOC entry 3421 (class 2606 OID 16500)
...
--
-- TOC entry 3428 (class 2606 OID 16504)
...
--
-- TOC entry 3432 (class 2606 OID 16506)
...
--
-- TOC entry 3435 (class 2606 OID 16508)
...
--
-- TOC entry 3437 (class 2606 OID 32806)
...
--
-- TOC entry 3439 (class 2606 OID 16510)
...
--
-- TOC entry 3441 (class 2606 OID 24582)
...
--
-- TOC entry 3417 (class 1259 OID 16513)
...
--
-- TOC entry 3411 (class 1259 OID 16514)
...
--
-- TOC entry 3418 (class 1259 OID 16515)
...
--
-- TOC entry 3419 (class 1259 OID 16516)
...
--
-- TOC entry 3414 (class 1259 OID 16517)
...
--
-- TOC entry 3422 (class 1259 OID 16518)
...
--
-- TOC entry 3433 (class 1259 OID 16519)
...
--
-- TOC entry 3407 (class 1259 OID 16520)
...
--
-- TOC entry 3429 (class 1259 OID 16521)
...
--
-- TOC entry 3430 (class 1259 OID 16523)
...
--
-- TOC entry 3454 (class 2620 OID 16524)
...
--
-- TOC entry 3458 (class 2620 OID 16525)
...
--
-- TOC entry 3459 (class 2620 OID 16526)
...
--
-- TOC entry 3455 (class 2620 OID 16527)
...
--
-- TOC entry 3456 (class 2620 OID 32819)
...
--
-- TOC entry 3457 (class 2620 OID 16528)
...
--
-- TOC entry 3442 (class 2606 OID 16529)
...
--
-- TOC entry 3443 (class 2606 OID 16534)
...
--
-- TOC entry 3444 (class 2606 OID 16539)
...
--
-- TOC entry 3445 (class 2606 OID 16544)
...
--
-- TOC entry 3448 (class 2606 OID 16549)
...
--
-- TOC entry 3449 (class 2606 OID 16554)
...
--
-- TOC entry 3450 (class 2606 OID 16559)
...
--
-- TOC entry 3451 (class 2606 OID 24590)
...
--
-- TOC entry 3446 (class 2606 OID 16564)
...
--
-- TOC entry 3447 (class 2606 OID 16569)
...
--
-- TOC entry 3452 (class 2606 OID 24605)
...
--
-- TOC entry 3453 (class 2606 OID 32797)
...
\restrict x0j5TQUhoxYoOcEcdBUmS7fMF0ovN1dPCY2fJGvui2gkoPoonWfiPOJBtWNyLMU
...
-- Completed on 2026-01-18 22:31:39 +05

--
-- PostgreSQL database dump complete
--

\unrestrict x0j5TQUhoxYoOcEcdBUmS7fMF0ovN1dPCY2fJGvui2gkoPoonWfiPOJBtWNyLMU
